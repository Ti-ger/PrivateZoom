...
class ActivityClusterer(AbstractClusterer):
    ...
    def build_abstractions(self, col_name) -> dict:
        return {
            f"{col_name}_abstracted": ActivityAbstraction(col_name, col_name, instance_clusterer.abstract_instance_complete, 0),
            f"{col_name}_bygroup": ActivityAbstraction("org:group", col_name, instance_clusterer.abstract_instance, 1),
            f"{col_name}_not_abstracted": ActivityAbstraction(col_name, col_name, instance_clusterer.abstract_instance, 100),
        }
